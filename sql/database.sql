...
-- Database Schema (PRODUCTION VERSION - For InfinityFree)
-- ============================================================
-- This file contains the complete database structure for TaskFlow
--
-- FOR LOCALHOST: Use database-localhost.sql instead
-- FOR PRODUCTION (InfinityFree/000webhost): Use this file
--
-- IMPORTANT:
-- - Database must be created beforehand via hosting control panel
